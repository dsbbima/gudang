...
if (typeof SCRIPT_URL === 'undefined') { 
    var SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyjXcccUD3GmQpZHOll7-qMbPW16_yiwbv_dOGXHhkoiA0NQDuFzqWZ3B6bRMSFT6hq/exec"; 
}
...
async function handleInventorySubmit(e) {
    ...
    document.querySelectorAll('.item-row').forEach(row => {
        ...
        const base = {
            ...
            barcode: row.querySelector('.h-barcode').value || "-",
            divisi: row.querySelector('.h-divisi').value || "-",
...
window.renderHistory = function() {
    ...
    // Tambahkan styling agar riwayat bisa di-scroll mandiri
    historyBox.style.maxHeight = "350px"; 
    historyBox.style.overflowY = "auto";
    historyBox.style.webkitOverflowScrolling = "touch"; // Smooth scroll di iOS
...
function saveToLocalHistory(newItems) {
    ...
    // Batasi riwayat hanya 15 item terbaru agar performa tetap ringan
